...
include_once("/var/www/vhosts/apothekerkammer.de/httpdocs/morpheus/newsletter/function.php");
...
//		echo "import";
	...
	if (mysqli_num_rows($res) < 1) { echo '<br><br>KEINE NEWSLETTER MEHR ZU VERSENDEN !!!!'; die(); }
	else {		
...
#			include("../../morpheus/newsletter/phpmailer.php");
			include("/var/www/vhosts/apothekerkammer.de/httpdocs/morpheus/newsletter/mail.php");
