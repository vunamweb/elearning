...
echo '<div id=vorschau>
	...
	'. ($edit || $neu ? '<p><a href="?pid='.$pid.'"><i class="fa fa-chevron-left small"></i> zur&uuml;ck</a></p>' : '') .'
	<form action="" onsubmit="" name="verwaltung" method="post">
';

$new = '<p>&nbsp;</p><p><a href="?neu=1"><i class="fa fa-plus small"></i> NEUER Ordner erste Ebene</a></p>';
