...
elseif ($delete && $status == "admin") {
	#$query = "delete from image where cid=$delete";
	#safe_query($query);
}
...
if ($nid) 		echo "<p><a href='news.php?edit=$nid&ngid=$ngid'>" .backlink() ." zur&uuml;ck</a></p>\n";
elseif ($back) 	echo "<p><a href='content_foto.php?edit=$cid&db=content&back=$back'>" .backlink() ." zur&uuml;ck</a></p>\n";
...
echo "</table>";
$new = "<p><a href=\"image_ordner.php?neu=1\" title=\"Neuen Imageordner erstellen\">" .ilink() ." NEU</a></p>";
