...
$arr_form = array(
	...
	array("bezeichnung", "Abteilung", '<input type="Text" value="#v#" name="#n#" style="#s#">'),
...
elseif ($delete) {
	$sql = "DELETE FROM morp_mitarbeiter_abt WHERE sid=$delete";
	$res = safe_query($sql);
}
