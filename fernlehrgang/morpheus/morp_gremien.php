...
//// EDIT_SKRIPT
$um_wen_gehts 	= "Gremium";
$titel			= "Gremien und Gruppen";
///////////////////////////////////////////////////////////////////////////////////////
...
$arr_form = array(
	array("gremium", "Gremium / Gruppen Bezeichnung", '<input type="Text" value="#v#" name="#n#" style="#s#">'),
...
function liste() {
	...
	while ($row = mysqli_fetch_object($res)) {
		...
		$echo .= '			<tr>
			...
			<td valign="top"><a href="?edit='.$edit.'"><i class="fa fa-pencil-square-o"></i></a></td>
...
elseif ($delete) {
	$sql = "DELETE FROM morp_gremien WHERE gid=$delete";
	$res = safe_query($sql);
}
elseif ($delimg) {
	$sql = "UPDATE morp_gremien set $delimg='' WHERE gid=$edit";
	$res = safe_query($sql);
}
