...
$res 		= mysqli_list_tables($morpheus["dbname"]);
...
# echo '<p><a href="http://www.source-werbemittel.de/wa3/_update.php" target="_blank">starten &raquo;</a></p>';
# mail('post@pixel-dusche.de', 'START - Alle DB ausgelsen und per FTP an Synergetic', "Alle DB ausgelsen und per FTP an Synergetic\n".date("d.m-Y H:i"));
?>
