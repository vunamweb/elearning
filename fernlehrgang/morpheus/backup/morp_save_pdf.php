...
function klammer($val) {
	return preg_replace(array("/&le;/","/&ge;/","/#<#/","/#>#/", "/< /"), array(' <img src="../images/klgl.png" style="padding-top:5px"> ',' <img src="../images/grgl.png" style="padding-top:5px"> ',' <img src="../images/klgl.png" style="padding-top:5px"> ',' <img src="../images/grgl.png" style="padding-top:5px"> ', " &lt; "), $val);
}
function klammer2($val) {
	return preg_replace(array("/&le;/","/&ge;/","/#<#/","/#>#/"), array(' <img src="../images/klgl.png" style="padding-top:5px"> ',' <img src="../images/grgl.png" style="padding-top:5px"> ',' <img src="../images/klgl.png" style="padding-top:5px"> ',' <img src="../images/grgl.png" style="padding-top:5px"> '), $val);
}
...
<head>
  <style>
   ...
   body,h1,h2,h3,h4,h5,div,table,tr,td,p{font-family: Univers-55}
    ...
    .headline-page1
    {
       border:1px solid #'.$color1.';border-radius:0 0 60px 0;border-left:0px solid red;padding:15px 20px 10px;position:relative;margin-top:14px;
    }
    ...
    .footer-top{padding:20px 0 30px 20px; border:1px solid #'.$color1.';border-radius:0 0 0 50px;height:230px;font-size:12px}
...
$html.='<div class="logo-page1">
                ...
                <p style="padding-top:0;margin-top:-10px;padding-left:30px;color:#'.$color1.';font-family:Univers BlackExt;width:200px;font-size:21px"> &nbsp; </p>
...
$html.= "<div style='color:#".$color1.";line-height:85px;margin-left:18px'>
 ...
 $html.=      '
       <div class="page2">
          <div style="float:left;font-family:Univers BlackExt;width:300px;">
              ...
              <p style="color:#'.$color1.';font-family:Univers BlackExt;font-size:21px"><!--Soja Protein--></p>
          </div>
          <div style="float:left;margin-left: 20px;margin-top: -63px;line-height:1.5em">
            <p style="color:#'.$color1.';font-family:Univers-57-Condensed;font-size:20px"><span style="font-size:50px;padding-right:5px;font-family:Univers-LightUltraCondensed">'.($page1_text_top[0]).'</span> <!--'.$page1_text_top[1].'--></p>
...
while ($row = mysql_fetch_object($res)) {
  ...
  <tr><td colspan="2" style="background:#'.$color1.';height:20px"></td></tr>';
  //item of page 2 header
  $db = "page2_header_item";
  $sql = "SELECT * FROM $db where id_page2_header=".$row->id." ORDER BY name";
  $res1 = safe_query($sql);
  $k=0;
  while ($row1 = mysql_fetch_object($res1)) {
     ...
     $html.='<tr '.$style.'>
                ...
                <td valign="top" width="50%">'.klammer($row1->value).'</td>
              </tr>';
     $k++;
  }
  $html.='</table></div>';
...
while ($row = mysql_fetch_object($res)) {
  ...
  $sql = "SELECT * FROM $db where id_page2_footer=".$row->id." ORDER BY name";
  $res1 = safe_query($sql);
  $k=0;
  $dl=1;
  while ($row1 = mysql_fetch_object($res1)) {
    if($row1->name!="")
    {
         ...
         $html.='<tr '.$style.' >
                    ...
                    <td  width="30%">'.klammer($row1->value).'</td>
                  </tr>';
         $k++;
    }
  }
...
<!-- page3  !-->
       ...
       <div class="page3">
          ...
          <div style="clear:both"></div>
          <div class="detail">
             <p style="font-size:18px;color:#706F6F;margin-bottom:7px;margin-top:40px;font-family:Univers-57-Condensed">ALLERGIENLISTE</p>
             <table width="100%">
              <tr style="background:#'.$color1.';color:#fff;font-size:14px;font-weight:700">
...
<!-- page4  !-->
       ...
       <div class="page4">
          ...
          <div class="detail">
            ...
            <table width="100%">
              <tr style="background:#'.$color1.';color:#fff;font-size:14px;">
...
<div class="footer-bottom">
  ...
  <div style="float:left;width:30%;padding-left:20px;padding-top:40px;font-size:0.9em;line-height:1.1em;">
    Phone: +49 761 208 52 15<br>
    E-Mail: salamone@efos.de <br>
  </div>
  <div style="clear:both"></div>
  <br>
