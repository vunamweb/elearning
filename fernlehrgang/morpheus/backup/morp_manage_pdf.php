...
else if($download)
{
    ?>
      <script>
        window.open('morp_save_pdf.php?id_pdf=<?php echo $download ?>');
      </script>
    <?php
}
else if($view)
...
else if($update)
{
    ...
    $db = "pdf_store";
    $sql="update $db set title='".$title."' where id=".$edit."";
    safe_query($sql);
    echo liste();
...
function page($page)
{
   echo '
           <ul style="list-style:none">
			  <li> <a href="morp_page1-text-top.php?edit='.$page.'"> <i class="fa fa-recycle"></i> <b>Produktbezeichnung</b> </a></li>
              <li> <br/><a href="morp_color.php?edit='.$page.'"> <i class="fa fa-eyedropper"></i> Warengruppe </a></li>
			  <li> <a href="morp_icon.php?id_pdf='.$page.'"> <i class="fa fa-language"></i> Icons </a></li>
              <li><br/><a> <i class="fa fa-file-code-o"></i> Seite 1</a>
		<ul>
           <li> <a href="morp_page1-headline.php?id_pdf='.$page.'"> Text Box </a></li>
<!--            <li> <a href="#"> Text </a>
             <ul>
               <li> <a href="morp_page1-text-bottom.php?edit='.$page.'"> Bottom </a></li>
             </ul>
           </li>-->
        </ul>
      </li>
      <li><br><a href="#"> <i class="fa fa-database"></i> Tabellen</a>
         <ul>
           <li> <a href="morp_page2-header.php?id_pdf='.$page.'"> Tabellen anlegen: VOR zentrierten Text </a>
              <ul>
                <li> <a href="morp_page2-header-item.php?id_pdf='.$page.'"> Einträge Tabelle </a></li>
             </ul>
           </li>
           <li> <a href="morp_page2-text.php?edit='.$page.'"> zentrierter Text </a></li>
           <li> <a href="morp_page2-footer.php?id_pdf='.$page.'"> Tabellen anlegen: NACH zentrierten Text // 2 Spalten</a>
              <ul>
                <li> <a href="morp_page2-footer-item.php?id_pdf='.$page.'"> Einträge Tabelle </a></li>
             </ul>
           </li>
         </ul>
      </li><br><a href="morp_edit_checkbox.php?id_pdf='.$page.'"> <i class="fa fa-check-square-o"></i> Allergienliste</a></li>
      <li></li>
    </ul>
    ';
}
function liste() {
	...
	while ($row = mysql_fetch_object($res)) {
		$edit = $row->$id;
        $echo .= '<tr>
            <td width="60"><p><a href="?page='.$edit.'"> <i class="fa fa-pencil-square-o"></i></a></p></td>
			<td width="450"><p><a href="?page='.$edit.'"> '.$row->title.' ('.$row->id.')</a></p></td>
            <td valign="top" width="50"><a href="?edit='.$edit.'"><i class="fa fa-cogs"></a></td>
            <td valign="top" width="50"><a href="?add='.$edit.'"><i class="fa fa-plus mrg30"></a></td>
            <td valign="top" width="50"><a href="?download='.$edit.'"><i class="fa fa-download mrg30"></a></td>
