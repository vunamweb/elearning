ALTER TABLE  `content` ADD  `navid` INT( 11 ) NOT NULL AFTER  `cid`;
ALTER TABLE  `content` ADD    `vid` int(11) NOT NULL;
ALTER TABLE  `content` ADD   `vorlage` int(1) NOT NULL;
ALTER TABLE  `content` ADD   `vorl_name` varchar(30) character set utf8 collate utf8_unicode_ci NOT NULL;
ALTER TABLE  `content` ADD   `pos` int(11) NOT NULL default '1';
ALTER TABLE  `content` ADD   `img0` int(11) default NULL;
ALTER TABLE  `content` ADD   `img5` int(11) NOT NULL default '0';
ALTER TABLE  `content` ADD    `img6` int(11) NOT NULL default '0';
ALTER TABLE  `content` ADD   `tid` int(11) NOT NULL default '1';
ALTER TABLE  `content` ADD   `ton` int(1) NOT NULL default '1';
ALTER TABLE  `content` ADD   `tpos` int(11) NOT NULL;
ALTER TABLE  `content` ADD   `tlink` varchar(100) character set utf8 collate utf8_unicode_ci default NULL;
ALTER TABLE  `content` ADD   `tbackground` varchar(100) character set utf8 collate utf8_unicode_ci default NULL;
ALTER TABLE  `content` ADD   `timage` varchar(255) character set utf8 collate utf8_unicode_ci NOT NULL;
ALTER TABLE  `content` ADD   `theadl` varchar(80) character set utf8 collate utf8_unicode_ci NOT NULL;
ALTER TABLE  `content` ADD   `theight` int(11) NOT NULL;
ALTER TABLE  `content` ADD   `twidth` int(11) NOT NULL;
ALTER TABLE  `content` ADD    `tcolor` varchar(6) character set utf8 collate utf8_unicode_ci NOT NULL;
ALTER TABLE  `content` ADD    `tref` int(11) NOT NULL;

ALTER TABLE  `delete` ADD  `dat` TIMESTAMP NOT NULL;

ALTER TABLE  `form` ADD  `extended` INT( 1 ) NOT NULL;

ALTER TABLE  `img_group` ADD  `art` INT( 1 ) NOT NULL DEFAULT  '1';


ALTER TABLE  `nav` ADD  `emotional` INT( 11 ) NOT NULL ,
ADD  `design` INT( 11 ) NOT NULL ,
ADD  `oldlnk` VARCHAR( 255 ) NOT NULL;


ALTER TABLE  `news` ADD  `hid` INT( 11 ) NOT NULL ,
ADD  `sichtbar` INT( 1 ) NOT NULL DEFAULT  '1';

ALTER TABLE  `pdf` ADD  `pimage` VARCHAR( 150 ) NOT NULL;
...
while ($row = mysqli_fetch_object($res)) {
	$id = $row->cid;
	$sql = "UPDATE content set navid=$id WHERE cid=$id";
	safe_query($sql);
}
*/
