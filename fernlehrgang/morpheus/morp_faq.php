...
';
	...
	foreach($arr_form as $arr) {	
		...
		elseif ($arr[2] == "foto") {
			$echo .= '<tr><td width="160">'.$arr[1].'</td><td><input type=hidden name='.$arr[0].' value="' .$row->$arr[0].'" style="width:500px"><a href="image_folder_upload.php?faqid='.$edit.'&tn='.$morpheus["img_size_news_tn"].'&imgid='.$arr[0].'&objekt=1">';
