...
--
-- Host: mysql5.skibicki.abcde.biz
-- Erstellungszeit: 08. Feb 2017 um 17:11
...
--
-- Datenbank: `db475670_11`
--

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `6_color`
--
...
--
-- Tabellenstruktur für Tabelle `checkbox`
--
...
--
-- Tabellenstruktur für Tabelle `checkbox_english`
--
...
--
-- Daten für Tabelle `checkbox_english`
--
...
--
-- Tabellenstruktur für Tabelle `page1_headline`
--
...
--
-- Daten für Tabelle `page1_headline`
--
...
--
-- Tabellenstruktur für Tabelle `page1_logo`
--
...
--
-- Tabellenstruktur für Tabelle `page1_text_bottom`
--
...
--
-- Daten für Tabelle `page1_text_bottom`
--
...
--
-- Tabellenstruktur für Tabelle `page1_text_top`
--
...
--
-- Daten für Tabelle `page1_text_top`
--
...
--
-- Tabellenstruktur für Tabelle `page2_footer`
--
...
--
-- Daten für Tabelle `page2_footer`
--
...
--
-- Tabellenstruktur für Tabelle `page2_footer_item`
--
...
--
-- Daten für Tabelle `page2_footer_item`
--
...
--
-- Tabellenstruktur für Tabelle `page2_header`
--
...
--
-- Daten für Tabelle `page2_header`
--
...
--
-- Tabellenstruktur für Tabelle `page2_header_item`
--
...
--
-- Daten für Tabelle `page2_header_item`
--
...
--
-- Tabellenstruktur für Tabelle `page2_text`
--
...
--
-- Tabellenstruktur für Tabelle `pdf_checkbox`
--
...
--
-- Daten für Tabelle `pdf_checkbox`
--
...
--
-- Tabellenstruktur für Tabelle `pdf_checkbox_english`
--
...
--
-- Daten für Tabelle `pdf_checkbox_english`
--
...
--
-- Tabellenstruktur für Tabelle `pdf_store`
--
...
(2, 0, '', '', 'vu', '', '', '', '', 0, '0000-00-00', '', '81dc9bdb52d04dc20036dbd8313ed055', '', '', '', '', '', '', '', 0, '', '1', 1),
...
(22, 1, 'vu', 'nam', 'vunam', 'strass', 'haus', 'plz', 'ort', 16, '2017-02-15', 'sch', 'e10adc3949ba59abbe56e057f20f883e', 'vukynamkhtn@gmail.com', 'dd@yahoo.com', '12334466', '444', 'bes', '', '2017-02-16', 1, '5839c945c6583d7372946fd77abdecf5', NULL, 0);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `user_test`
--
...
--
-- Daten für Tabelle `user_test`
--

INSERT INTO `user_test` (`id`, `id_user`, `date_test`, `test`, `status`, `value`) VALUES
(31, 17, '2017-02-02', 1, 0, '1_1,1_2,2_3,3_1,2_2,'),
(30, 17, '2017-02-02', 1, 0, '1_1,1_2,2_3,3_1,'),
(32, 17, '2017-02-02', 1, 0, '1_1,1_2,2_3,3_1,2_2,3_2,3_3,'),
(33, 18, '2017-02-02', 1, 0, '1_1,1_3,2_2,3_1,'),
(34, 18, '2017-02-02', 1, 1, '1_1,,2_2,3_1,1_2,2_1,3_2,'),
(35, 19, '2017-02-03', 1, 0, '1_2,1_4,2_2,3_1,'),
(36, 19, '2017-02-03', 1, 0, '1_2,2_3,3_1,'),
(37, 20, '2017-02-08', 1, 1, '1_3,1_4,2_1,2_2,3_1,3_4,4_2,4_4,5_2,5_3,6_2,7_4,8_1,9_2,10_3,');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `user_test_active`
--
...
--
-- Daten für Tabelle `user_test_active`
--

INSERT INTO `user_test_active` (`id`, `id_user`, `test`, `active`) VALUES
(6, 18, 2, 1),
(7, 20, 2, 1);
...
--
-- Indizes für die Tabelle `6_color`
--
ALTER TABLE `6_color`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `checkbox`
--
ALTER TABLE `checkbox`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `checkbox_english`
--
...
--
-- Indizes für die Tabelle `content_history`
--
...
--
-- Indizes für die Tabelle `delete`
--
ALTER TABLE `delete`
  ADD PRIMARY KEY (`id`);
...
--
-- Indizes für die Tabelle `form_auswertung`
--
...
--
-- Indizes für die Tabelle `galerie_group`
--
ALTER TABLE `galerie_group`
  ADD PRIMARY KEY (`ggid`);

--
-- Indizes für die Tabelle `galerie_name`
--
...
--
-- Indizes für die Tabelle `img_group`
--
ALTER TABLE `img_group`
  ADD PRIMARY KEY (`gid`);

--
-- Indizes für die Tabelle `morp_color`
--
ALTER TABLE `morp_color`
  ADD PRIMARY KEY (`colid`);

--
-- Indizes für die Tabelle `morp_customer`
--
ALTER TABLE `morp_customer`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `morp_download`
--
ALTER TABLE `morp_download`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `morp_download_historie`
--
ALTER TABLE `morp_download_historie`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `morp_email`
--
ALTER TABLE `morp_email`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `morp_fa`
--
ALTER TABLE `morp_fa`
  ADD PRIMARY KEY (`faid`);

--
-- Indizes für die Tabelle `morp_intern`
--
ALTER TABLE `morp_intern`
  ADD PRIMARY KEY (`mid`);

--
-- Indizes für die Tabelle `morp_kurse`
--
ALTER TABLE `morp_kurse`
  ADD PRIMARY KEY (`kid`);

--
-- Indizes für die Tabelle `morp_kursplan`
--
ALTER TABLE `morp_kursplan`
  ADD PRIMARY KEY (`pid`);

--
-- Indizes für die Tabelle `morp_mitarbeiter`
--
ALTER TABLE `morp_mitarbeiter`
  ADD PRIMARY KEY (`mid`);

--
-- Indizes für die Tabelle `morp_sprachdatei`
--
ALTER TABLE `morp_sprachdatei`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `morp_stimmen`
--
ALTER TABLE `morp_stimmen`
  ADD PRIMARY KEY (`stid`);

--
-- Indizes für die Tabelle `morp_suche_count`
--
...
--
-- Indizes für die Tabelle `morp_suche_keyw`
--
...
--
-- Indizes für die Tabelle `morp_trainer`
--
...
--
-- Indizes für die Tabelle `news_group`
--
ALTER TABLE `news_group`
  ADD PRIMARY KEY (`ngid`);

--
-- Indizes für die Tabelle `nl_verteiler`
--
ALTER TABLE `nl_verteiler`
  ADD UNIQUE KEY `vid` (`vid`);

--
-- Indizes für die Tabelle `page1_headline`
--
ALTER TABLE `page1_headline`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `page1_logo`
--
ALTER TABLE `page1_logo`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `page1_text_bottom`
--
ALTER TABLE `page1_text_bottom`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `page1_text_top`
--
ALTER TABLE `page1_text_top`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `page2_footer`
--
ALTER TABLE `page2_footer`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `page2_footer_item`
--
ALTER TABLE `page2_footer_item`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `page2_header`
--
ALTER TABLE `page2_header`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `page2_header_item`
--
ALTER TABLE `page2_header_item`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `page2_text`
--
...
--
-- Indizes für die Tabelle `pdf_checkbox`
--
ALTER TABLE `pdf_checkbox`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `pdf_checkbox_english`
--
ALTER TABLE `pdf_checkbox_english`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `pdf_group`
--
ALTER TABLE `pdf_group`
  ADD PRIMARY KEY (`pgid`);

--
-- Indizes für die Tabelle `pdf_store`
--
ALTER TABLE `pdf_store`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `pfad`
--
ALTER TABLE `pfad`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `user_test`
--
ALTER TABLE `user_test`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `user_test_active`
--
ALTER TABLE `user_test_active`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `z_protokoll`
--
...
--
-- AUTO_INCREMENT für Tabelle `6_color`
--
ALTER TABLE `6_color`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
-- AUTO_INCREMENT für Tabelle `checkbox`
--
ALTER TABLE `checkbox`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
-- AUTO_INCREMENT für Tabelle `checkbox_english`
--
ALTER TABLE `checkbox_english`
...
--
-- AUTO_INCREMENT für Tabelle `content_history`
--
ALTER TABLE `content_history`
...
--
-- AUTO_INCREMENT für Tabelle `delete`
--
ALTER TABLE `delete`
...
--
-- AUTO_INCREMENT für Tabelle `form_auswertung`
--
ALTER TABLE `form_auswertung`
  MODIFY `aid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `form_field`
--
ALTER TABLE `form_field`
...
--
-- AUTO_INCREMENT für Tabelle `galerie_group`
--
ALTER TABLE `galerie_group`
  MODIFY `ggid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `galerie_name`
--
ALTER TABLE `galerie_name`
...
--
-- AUTO_INCREMENT für Tabelle `img_group`
--
ALTER TABLE `img_group`
  MODIFY `gid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT für Tabelle `morp_color`
--
ALTER TABLE `morp_color`
  MODIFY `colid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT für Tabelle `morp_customer`
--
ALTER TABLE `morp_customer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `morp_download`
--
ALTER TABLE `morp_download`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `morp_download_historie`
--
ALTER TABLE `morp_download_historie`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `morp_email`
--
ALTER TABLE `morp_email`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `morp_fa`
--
ALTER TABLE `morp_fa`
  MODIFY `faid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=345;
--
-- AUTO_INCREMENT für Tabelle `morp_intern`
--
ALTER TABLE `morp_intern`
  MODIFY `mid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `morp_kurse`
--
ALTER TABLE `morp_kurse`
  MODIFY `kid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT für Tabelle `morp_kursplan`
--
ALTER TABLE `morp_kursplan`
  MODIFY `pid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
--
-- AUTO_INCREMENT für Tabelle `morp_mitarbeiter`
--
ALTER TABLE `morp_mitarbeiter`
  MODIFY `mid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `morp_sprachdatei`
--
ALTER TABLE `morp_sprachdatei`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `morp_stimmen`
--
ALTER TABLE `morp_stimmen`
  MODIFY `stid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `morp_suche_count`
--
ALTER TABLE `morp_suche_count`
  MODIFY `sid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `morp_suche_keyw`
--
ALTER TABLE `morp_suche_keyw`
  MODIFY `kid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `morp_trainer`
--
ALTER TABLE `morp_trainer`
...
--
-- AUTO_INCREMENT für Tabelle `news_group`
--
ALTER TABLE `news_group`
  MODIFY `ngid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT für Tabelle `nl_verteiler`
--
ALTER TABLE `nl_verteiler`
  MODIFY `vid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `page1_headline`
--
ALTER TABLE `page1_headline`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=257;
--
-- AUTO_INCREMENT für Tabelle `page1_logo`
--
ALTER TABLE `page1_logo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=342;
--
-- AUTO_INCREMENT für Tabelle `page1_text_bottom`
--
ALTER TABLE `page1_text_bottom`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
-- AUTO_INCREMENT für Tabelle `page1_text_top`
--
ALTER TABLE `page1_text_top`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
--
-- AUTO_INCREMENT für Tabelle `page2_footer`
--
ALTER TABLE `page2_footer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
--
-- AUTO_INCREMENT für Tabelle `page2_footer_item`
--
ALTER TABLE `page2_footer_item`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=726;
--
-- AUTO_INCREMENT für Tabelle `page2_header`
--
ALTER TABLE `page2_header`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;
--
-- AUTO_INCREMENT für Tabelle `page2_header_item`
--
ALTER TABLE `page2_header_item`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=639;
--
-- AUTO_INCREMENT für Tabelle `page2_text`
--
ALTER TABLE `page2_text`
...
--
-- AUTO_INCREMENT für Tabelle `pdf_checkbox`
--
ALTER TABLE `pdf_checkbox`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=600;
--
-- AUTO_INCREMENT für Tabelle `pdf_checkbox_english`
--
ALTER TABLE `pdf_checkbox_english`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT für Tabelle `pdf_group`
--
ALTER TABLE `pdf_group`
  MODIFY `pgid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT für Tabelle `pdf_store`
--
ALTER TABLE `pdf_store`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
--
-- AUTO_INCREMENT für Tabelle `pfad`
--
ALTER TABLE `pfad`
...
--
-- AUTO_INCREMENT für Tabelle `user_test`
--
ALTER TABLE `user_test`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
-- AUTO_INCREMENT für Tabelle `user_test_active`
--
ALTER TABLE `user_test_active`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT für Tabelle `z_protokoll`
--
ALTER TABLE `z_protokoll`
