...
/* vu nam */
  ...
  if(isset($_POST['register']))
 {
    ...
    if($class=="")
    {
        ...
        echo "Vielen Dank für Ihre Registrierung. Sie erhalten eine E-Mail zur Aktivierung Ihres Account";
    }
 ...
 if(isset($_POST['login']))
 {
    ...
    {
       $message="<p class='error'>Falscher Email oder Passwort</p>";
    }
 }
 //END check login
 //Check session login
 ...
 if(isset($_POST['test']))
 {
     ...
     if($_POST['status']==0)
     {
        ...
        else
        {
            ...
            //if faild <2 times
              ...
              echo 'Sie haben die Fernlehrgang-Prüfung zum '.$count.'. Mal nicht bestanden. Sie können die Fernlehrgang-Prüfung noch '.$rest_test.' Mal durchführen.';
     ...
     else
     {
        ...
        if($test<6)
        {
          ...
          safe_query($sql);
          echo 'Herzlichen Glückwunsch. Sie haben die Fernlehrgangs-Prüfung bestanden. In 2 Wochen erhalten Sie die Freigabe für die nächste Prüfung.';
        }
        elseif($test == 6)
        {
          $sql="insert into user_test_active(id_user,test,active)values(".$id_user.",".$test.",1)";
          safe_query($sql);
          echo 'Herzlichen Glückwunsch. Sie haben den Fernlehrgang bestanden. Sie erhalten von uns Ihr Zertifikat per E-Mail.';
          // create pdf
          // PDF ready
          ...
          //send email with attach pdf
            ...
            //end
            //header
            $email_body='Congratulation '.$_SESSION[username].'. You passed all online test .We will contact soon and give you more detail';
            ...
            mail($_SESSION['email'],"Congratulation for passing all test",$message,$headers);
        }
     }
 return;
 }
